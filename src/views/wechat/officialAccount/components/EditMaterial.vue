          ...
          >
            ...
            >
              <el-upload
                ...
                :action="`${baseURL}common/wechat/material/voice/create?name=${resourceForm.name}`"
                :auto-upload="false"
                :limit="1"
                :on-change="onChange"
            ...
            <template v-if="type === '3' && detail_id">
              <el-form-item label="选择素材：" prop="src">
                <el-upload
                  ...
                  :headers="uploadHeaders"
                  accept="audio/mpeg,audio/x-ms-wma,audio/wav,audio/amr"
                  :action="`${baseURL}common/wechat/material/voice/update/${detail_id}?name=${resourceForm.name}`"
                  :auto-upload="false"
                  :limit="1"
                  :on-change="onChange"
                  :before-upload="beforeUpload"
            ...
            >
              <el-upload
                ...
                :headers="uploadHeaders"
                accept="video/mp4"
                :action="`${baseURL}common/wechat/material/video/create?name=${resourceForm.name}&introduction=${resourceForm.introduction}`"
                :auto-upload="false"
                :limit="1"
                :on-change="onChange"
                :before-upload="beforeUpload"
            ...
            <template v-if="type === '4' && detail_id">
              <el-form-item label="选择素材：" prop="src">
                <el-upload
                  ...
                  :headers="uploadHeaders"
                  accept="video/mp4"
                  :action="`${baseURL}common/wechat/material/video/update/${detail_id}?name=${resourceForm.name}&introduction=${resourceForm.introduction}`"
                  :auto-upload="false"
                  :limit="1"
                  :on-change="onChange"
                  :before-upload="beforeUpload"
